...
public class SoftwareUseTimeServiceTest {
    ...
    public void testBatchReportSoftwareUseTime() {
        Map<Long, Integer> params = new HashMap<Long, Integer>() {{
            put(1407990753380143105L, 80); // Google Chrome
            put(1407990753380143106L, 60); // WeChat
            put(1412375884870062080L, 41); // HBuilder X
            put(1407990753380143104L, 39); //IDEA
            put(1407990753380143109L, 13); // Xshell
            put(1407990753380143111L, 12); // 企业微信
            put(1407990753380143107L, 12); // 腾讯QQ
            put(1408017039897006082L, 7); // Visual Studio Code
            put(1407990753380143108L, 3); // Postman
            put(1409482786942881792L, 3); // WebStorm
            put(1408368116253200384L, 2); // Typora
            put(1408369150115581952L, 2); // 滴答清单
            put(1408368819264688128L, 2); // 网易邮箱大师
            put(1415270040378413056L, 1); // 墨刀
            put(1408016476153188352L, 1); // 终端
